...
def plot_error_summary(
    ...
    k_value: int = 15,
    save_path: str = "./fig/pendulumr/prediction_error_summary.png",
...
if __name__ == "__main__":
    ...
    file_config = [
        ("./results/pendulum/dkn_mc2_pred_results_K15_exp4.npz", "DKN + Manifold Constraints", "-", "o"),
        ("./results/pendulum/dkn_pred_results_K15_exp4.npz", "Baseline DKN", "--", "s"),
        ("./results/pendulum/kderiv_pendulum_pred_results_K15.npz", "KDeriv (Kernel Koopman)", "-.", "^"),
        ("./results/pendulum/krbf_pendulum_pred_results_K15.npz", "KRBF", ":", "D")
    ]
    ...
    plot_error_summary(
        ...
        k_value=15,
        save_path="./fig/pendulum/prediction_error_summary_final.png",
        xlim=(0, 30),
        ylim=(-5, 2)
    )
